...
**p₁^c₁ × p₂^c₂ × p₃^c₃** possible combinations, where:
...
**Example:**  
For Car Body, Rims, and Lights, each with 3 different materials, this already leads to thousands of combinations:

**3^3×3^3×3^3 = 3^9 = 19683**
...
#### Dependency Tables
!In the currently used script theres no dependency table implemented!
